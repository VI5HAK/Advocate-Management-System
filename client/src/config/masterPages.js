export const MASTER_PAGE_CONFIG = {
  ...
  district: {
    ...
    idPrefix: "district",
    title: "District",
    createButtonLabel: "Create District",
    createFormTitle: "Create District",
    updateFormTitle: "Update District",
    nameLabel: "District Name",
    descriptionLabel: "District Description",
    searchPlaceholder: "Search by district name or description",
    emptyMessage: "No districts found.",
    loadErrorMessage: "Failed to load districts.",
    saveErrorMessage: "Failed to save district.",
    deleteErrorMessage: "Failed to delete district.",
    deleteConfirm: (name) => `Delete district "${name}"?`,
  },
};
